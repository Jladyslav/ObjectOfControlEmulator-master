    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            connection = new HubConnectionBuilder()
                ...
                .Build();
            connection.On("Control", (string command) =>
            {
            ...
            var sensorFactories = new Dictionary<string, Func<Sensor>>
            {
                ...
                {"Weight", () => new WeightSensor("Weight", "Weight of material")},
                {"FillingRate", () => new FillingRateSensor("Filling Rate", "Filling rate of system")},
                {"Voltage", () => new VoltageSensor("Voltage", "System voltage")},
                {"MechanismTemperature", () => new MechanismTemperatureSensor("Mechanism Temperature", "Temperature of mechanisms")},
                {"ConveyorSpeed", () => new ConveyorSpeedSensor("Conveyor Speed", "Speed of the conveyor belt")},
        ...
        CancellationToken token, IndicatorModel indicatorModel)
        {
            ...
            {
                if (isRunning) // Проверка состояния процесса
                {
